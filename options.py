...
parser.add_argument('--resume_model_path', default='/dev/THUMOS14/Thumos14reduced/ckpt/last_DELU.pkl',
                    help='test model path')
parser.add_argument('--path_dataset', type=str,
                    default='/dev/THUMOS14/Thumos14reduced', help='the path of data feature')
parser.add_argument('--lr', type=float, default=0.00005,
                    help='learning rate (default: 0.0001)')
parser.add_argument('--batch_size', type=int, default=10,
                    help='number of instances in a batch of data (default: 10)')
parser.add_argument('--save_model_path', default='path to save model and log file',
                    help='path to save model')
parser.add_argument('--model_name', default='weakloc',
...
parser.add_argument('--use_multi_speed_feature', type=bool, default=False,
                    help='use multi speed features')
parser.add_argument('--use_multi_speed_feature_in_test', type=bool, default=False,
                    help='use multi speed features in test')
...
parser.add_argument('--use_model', type=str, default='DELU',
                    help='model used to train the network')
parser.add_argument('--interval', type=int, default=200,
                    help='time interval of performing the test')
...
# origin guide_loss coefficient
parser.add_argument("--alpha2", type=float, default=0.8,
                    help='guide loss = opposite loss')
...
parser.add_argument("--fusion_method", type=str, default='conv',
                    help='choose from conv inception')
